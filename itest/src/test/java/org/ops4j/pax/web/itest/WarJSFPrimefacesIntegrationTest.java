...
//	@Test
	public void testJSF() throws Exception {
		...
		testPost("http://127.0.0.1:8181/war-jsf-primefaces-sample/faces/helloWorld.xhtml", nameValuePairs, "Hello Dummy-User. We hope you enjoy Apache MyFaces", 200);
	...
	public void testPrimefacesTagRendering() throws Exception {
		...
		assertFalse("The Primefaces-tag <p:panelGrid> was not rendered correctly.", 
